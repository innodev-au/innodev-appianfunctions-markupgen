...
/**
 * An XML element containing only text, no tags.
 * 
 * @author juanal
 *
 */
public class StringXmlPartGen implements XmlPartGen {

	protected String value;
	
	public StringXmlPartGen(String value) {
		this.value = MarkupUtil.normaliseNullToEmptyString(value);
	}
	
	@Override
	public String getOutput() {
		return EscapeUtils.escapeXml(value);
	}
}
