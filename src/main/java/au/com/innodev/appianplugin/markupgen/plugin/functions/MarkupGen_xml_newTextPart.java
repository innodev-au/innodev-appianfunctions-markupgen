...
/**
 * Exposes an Appian function that creates an XML element with raw XML content.
 * 
 * @author juanal
 *
 */
@Category(MarkupGenFuncsCategory.FUNCTIONS_CATEGORY)
public class MarkupGen_xml_newTextPart {

	@Function
	public XmlPart markupGen_xml_newTextPart(@Parameter String text) 
			throws Exception {
		try {
			
			return XmlMarkupFacade.newTextXmlPart(text);
		} catch (Exception e) {
